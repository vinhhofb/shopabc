...
<div class="col-6 col-sm-6 col-md-4 col-lg-3 p-1 mt-2 mb-0">
  ...
  <div class="px-2">
    ...
    <p class="float-left mb-0" style="font-size:80%;margin-top: 6px;opacity: 0.8;">Selled: {{$GetProductRelates['count_sale']}}</p>  
    <p class="tx ml-2 font-weight-bold float-right my-1">{{number_format($GetProductRelates['price'])}}$</p>
    <div class="clboth"></div>
    @if(isset(Auth::user()->id))
    <button class="add-to-cart-button w-100 bg fz95 btn text-white" onclick="addToCart({{$GetProductRelates['id']}})"  style="border-radius: 0;">
Add to cart</button>
    @else
