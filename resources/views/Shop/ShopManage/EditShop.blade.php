                ...
                <div>
                  <div class="bg-white p-4">
                    ...
                    <form action="{{url('kenh-cua-hang/quan-ly-cua-hang/sua-cua-hang')."/".$GetShopById->id}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-6 pr-1">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Store" name="title" value="{{$GetShopById->name}}" required>
                          </div>
                        </div>
                        <div class="col-md-6 pr-1">
                          <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-info btn-fill pull-right">Edit Store</button>
